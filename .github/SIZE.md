```mathematica
 ...
 757M   │ ├─┬ pkgforge-go
 757M   │ │ ├─┬ data
  66M   │ │ │ ├── x86_64-Linux.json
  66M   │ │ │ ├── riscv64-Linux.json
  65M   │ │ │ ├── aarch64-Linux.json
  65M   │ │ │ ├── loongarch64-Linux.json
  53M   │ │ │ ├── x86_64-Linux.db
  53M   │ │ │ ├── riscv64-Linux.db
  53M   │ │ │ ├── loongarch64-Linux.db
  52M   │ │ │ ├── aarch64-Linux.db
  47M   │ │ │ ├── x86_64-Linux.sdb
  46M   │ │ │ ├── riscv64-Linux.sdb
  46M   │ │ │ ├── aarch64-Linux.sdb
  45M   │ │ │ ├── loongarch64-Linux.sdb
 4.8M   │ │ │ ├── x86_64-Linux.sdb.zstd
 4.7M   │ │ │ ├── riscv64-Linux.sdb.zstd
 4.7M   │ │ │ ├── aarch64-Linux.sdb.zstd
 4.6M   │ │ │ ├── loongarch64-Linux.sdb.zstd
 4.5M   │ │ │ ├── x86_64-Linux.db.zstd
 4.4M   │ │ │ ├── x86_64-Linux.sdb.xz
 4.4M   │ │ │ ├── riscv64-Linux.db.zstd
 4.4M   │ │ │ ├── aarch64-Linux.db.zstd
 4.4M   │ │ │ ├── riscv64-Linux.sdb.xz
 4.3M   │ │ │ ├── aarch64-Linux.sdb.xz
 4.3M   │ │ │ ├── loongarch64-Linux.db.zstd
 4.3M   │ │ │ ├── x86_64-Linux.db.xz
 4.2M   │ │ │ ├── loongarch64-Linux.sdb.xz
 4.2M   │ │ │ ├── riscv64-Linux.db.xz
 4.2M   │ │ │ ├── aarch64-Linux.db.xz
 4.1M   │ │ │ ├── loongarch64-Linux.db.xz
 4.1M   │ │ │ ├── x86_64-Linux.json.zstd
 4.0M   │ │ │ ├── riscv64-Linux.json.zstd
 4.0M   │ │ │ ├── aarch64-Linux.json.zstd
 3.9M   │ │ │ ├── loongarch64-Linux.json.zstd
...
1016K   │ │ │ ├── loongarch64-Linux.db.zstd
 996K   │ │ │ ├── loongarch64-Linux.sdb.xz
 972K   │ │ │ ├── loongarch64-Linux.db.xz
 924K   │ │ │ ├── loongarch64-Linux.json.zstd
 900K   │ │ │ ├── loongarch64-Linux.json.xz
 4.0K   │ │ │ ├── x86_64-Linux.sdb.zstd.bsum
 4.0K   │ │ │ ├── x86_64-Linux.sdb.xz.bsum
 ...
 836K   │ │ ├── COMP_VER_CACHE_OLD.json
 756K   │ │ ├── pub_issues_binaries.txt
 536K   │ │ ├── DIFF_bincache_aarch64-Linux.json
 524K   │ │ ├── DIFF_bincache_x86_64-Linux.json
 384K   │ │ ├── INDEX.json.cba
 348K   │ │ ├── COMP_VER_CACHE_OLD.md
 304K   │ │ ├── pub_issues_packages.txt
 300K   │ │ ├── OLD_pkgcache_x86_64-Linux.json
 272K   │ │ ├── DIFF_bincache_riscv64-Linux.json
 244K   │ │ ├── INDEX.db.cba
 240K   │ │ ├── GH_REPO.md
 236K   │ │ ├── INDEX.json.xz
