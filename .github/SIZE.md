...
1012K   │ │ ├── aarch64-Linux.sdb.zstd
 ...
 2.3M   │ │ │ ├── aarch64-Linux.json
 2.1M   │ │ │ ├── riscv64-Linux.json
 2.0M   │ │ │ ├── x86_64-Linux.db
 1.9M   │ │ │ ├── aarch64-Linux.db
 1.8M   │ │ │ ├── riscv64-Linux.db
 1.7M   │ │ │ ├── loongarch64-Linux.json
 1.4M   │ │ │ ├── loongarch64-Linux.db
 244K   │ │ │ ├── x86_64-Linux.db.zstd
 240K   │ │ │ ├── aarch64-Linux.db.zstd
 220K   │ │ │ ├── x86_64-Linux.json.zstd
 220K   │ │ │ ├── riscv64-Linux.db.zstd
 216K   │ │ │ ├── aarch64-Linux.json.zstd
 212K   │ │ │ ├── x86_64-Linux.json.xz
 212K   │ │ │ ├── aarch64-Linux.json.xz
 200K   │ │ │ ├── riscv64-Linux.json.zstd
 192K   │ │ │ ├── riscv64-Linux.json.xz
 180K   │ │ │ ├── loongarch64-Linux.db.zstd
 160K   │ │ │ ├── loongarch64-Linux.json.zstd
 156K   │ │ │ ├── loongarch64-Linux.json.xz
 4.0K   │ │ │ ├── x86_64-Linux.json.zstd.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.xz.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.bsum
 4.0K   │ │ │ ├── x86_64-Linux.db.zstd.bsum
