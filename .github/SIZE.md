...
877M   │ ├─┬ pkgforge-go
877M   │ │ ├─┬ data
 77M   │ │ │ ├── x86_64-Linux.json
 76M   │ │ │ ├── riscv64-Linux.json
 76M   │ │ │ ├── aarch64-Linux.json
 75M   │ │ │ ├── loongarch64-Linux.json
 61M   │ │ │ ├── x86_64-Linux.db
 61M   │ │ │ ├── loongarch64-Linux.db
 61M   │ │ │ ├── riscv64-Linux.db
 61M   │ │ │ ├── aarch64-Linux.db
 54M   │ │ │ ├── x86_64-Linux.sdb
 54M   │ │ │ ├── riscv64-Linux.sdb
 54M   │ │ │ ├── aarch64-Linux.sdb
 53M   │ │ │ ├── loongarch64-Linux.sdb
5.6M   │ │ │ ├── x86_64-Linux.sdb.zstd
5.5M   │ │ │ ├── riscv64-Linux.sdb.zstd
5.5M   │ │ │ ├── aarch64-Linux.sdb.zstd
5.3M   │ │ │ ├── loongarch64-Linux.sdb.zstd
5.2M   │ │ │ ├── x86_64-Linux.db.zstd
5.2M   │ │ │ ├── x86_64-Linux.sdb.xz
5.2M   │ │ │ ├── riscv64-Linux.db.zstd
5.2M   │ │ │ ├── aarch64-Linux.db.zstd
5.1M   │ │ │ ├── riscv64-Linux.sdb.xz
5.1M   │ │ │ ├── aarch64-Linux.sdb.xz
5.0M   │ │ │ ├── loongarch64-Linux.db.zstd
5.0M   │ │ │ ├── x86_64-Linux.db.xz
5.0M   │ │ │ ├── loongarch64-Linux.sdb.xz
5.0M   │ │ │ ├── riscv64-Linux.db.xz
4.9M   │ │ │ ├── aarch64-Linux.db.xz
4.8M   │ │ │ ├── loongarch64-Linux.db.xz
4.7M   │ │ │ ├── x86_64-Linux.json.zstd
4.7M   │ │ │ ├── riscv64-Linux.json.zstd
4.6M   │ │ │ ├── aarch64-Linux.json.zstd
4.6M   │ │ │ ├── loongarch64-Linux.json.zstd
...
9.3M   │ │ │ ├── loongarch64-Linux.db
8.9M   │ │ │ ├── x86_64-Linux.sdb
8.8M   │ │ │ ├── aarch64-Linux.sdb
8.5M   │ │ │ ├── riscv64-Linux.sdb
...
976K   │ │ │ ├── loongarch64-Linux.json.zstd
948K   │ │ │ ├── loongarch64-Linux.json.xz
4.0K   │ │ │ ├── x86_64-Linux.sdb.zstd.bsum
4.0K   │ │ │ ├── x86_64-Linux.sdb.xz.bsum
...
948K   │ │ ├── aarch64-Linux.sdb.xz
940K   │ │ ├── x86_64-Linux.db.zstd
932K   │ │ ├── aarch64-Linux.db.zstd
904K   │ │ ├── x86_64-Linux.json.zstd
896K   │ │ ├── aarch64-Linux.json.zstd
...
968K   │ │ ├── COMP_VER_bincache_aarch64-Linux.json
916K   │ │ ├── COMP_VER_CACHE.md
812K   │ │ ├── pub_issues_binaries.txt
580K   │ │ ├── OLD_bincache_riscv64-Linux.json
448K   │ │ ├── COMP_VER_CACHE_OLD.json
416K   │ │ ├── DIFF_bincache_aarch64-Linux.json
392K   │ │ ├── DIFF_bincache_x86_64-Linux.json
384K   │ │ ├── INDEX.json.cba
304K   │ │ ├── pub_issues_packages.txt
304K   │ │ ├── DIFF_bincache_riscv64-Linux.json
276K   │ │ ├── OLD_pkgcache_x86_64-Linux.json
248K   │ │ ├── INDEX.db.cba
240K   │ │ ├── GH_REPO.md
236K   │ │ ├── INDEX.json.xz
