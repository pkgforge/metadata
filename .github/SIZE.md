```mathematica
 ...
 9.2M   │ │ │ ├── x86_64-Linux.db
 9.1M   │ │ │ ├── aarch64-Linux.db
 8.8M   │ │ │ ├── loongarch64-Linux.json
 8.8M   │ │ │ ├── riscv64-Linux.db
 7.3M   │ │ │ ├── loongarch64-Linux.db
 1.0M   │ │ │ ├── x86_64-Linux.db.zstd
 1.0M   │ │ │ ├── aarch64-Linux.db.zstd
1016K   │ │ │ ├── riscv64-Linux.db.zstd
 968K   │ │ │ ├── x86_64-Linux.json.zstd
 960K   │ │ │ ├── aarch64-Linux.json.zstd
 940K   │ │ │ ├── x86_64-Linux.json.xz
 936K   │ │ │ ├── aarch64-Linux.json.xz
 924K   │ │ │ ├── riscv64-Linux.json.zstd
 900K   │ │ │ ├── riscv64-Linux.json.xz
 840K   │ │ │ ├── loongarch64-Linux.db.zstd
 764K   │ │ │ ├── loongarch64-Linux.json.zstd
 744K   │ │ │ ├── loongarch64-Linux.json.xz
 4.0K   │ │ │ ├── x86_64-Linux.json.zstd.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.xz.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.bsum
 4.0K   │ │ │ ├── x86_64-Linux.db.zstd.bsum
