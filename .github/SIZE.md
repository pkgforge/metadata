```mathematica
 ...
 224M   │ │ ├─┬ data
  ...
  28M   │ │ │ ├── riscv64-Linux.json
  27M   │ │ │ ├── loongarch64-Linux.json
  22M   │ │ │ ├── x86_64-Linux.db
  22M   │ │ │ ├── aarch64-Linux.db
  22M   │ │ │ ├── riscv64-Linux.db
  21M   │ │ │ ├── loongarch64-Linux.db
 2.1M   │ │ │ ├── x86_64-Linux.db.zstd
 2.1M   │ │ │ ├── aarch64-Linux.db.zstd
 2.1M   │ │ │ ├── riscv64-Linux.db.zstd
 2.0M   │ │ │ ├── loongarch64-Linux.db.zstd
 2.0M   │ │ │ ├── x86_64-Linux.json.zstd
 1.9M   │ │ │ ├── x86_64-Linux.json.xz
 1.9M   │ │ │ ├── aarch64-Linux.json.zstd
 1.9M   │ │ │ ├── riscv64-Linux.json.zstd
 1.9M   │ │ │ ├── aarch64-Linux.json.xz
 1.9M   │ │ │ ├── riscv64-Linux.json.xz
 1.8M   │ │ │ ├── loongarch64-Linux.json.zstd
 1.8M   │ │ │ ├── loongarch64-Linux.json.xz
 ...
 8.9M   │ │ │ ├── x86_64-Linux.db
 8.8M   │ │ │ ├── aarch64-Linux.db
 8.5M   │ │ │ ├── loongarch64-Linux.json
 8.4M   │ │ │ ├── riscv64-Linux.db
 7.0M   │ │ │ ├── loongarch64-Linux.db
 1.0M   │ │ │ ├── x86_64-Linux.db.zstd
1020K   │ │ │ ├── aarch64-Linux.db.zstd
 980K   │ │ │ ├── riscv64-Linux.db.zstd
 936K   │ │ │ ├── x86_64-Linux.json.zstd
 928K   │ │ │ ├── aarch64-Linux.json.zstd
 908K   │ │ │ ├── x86_64-Linux.json.xz
 904K   │ │ │ ├── aarch64-Linux.json.xz
 892K   │ │ │ ├── riscv64-Linux.json.zstd
 868K   │ │ │ ├── riscv64-Linux.json.xz
 812K   │ │ │ ├── loongarch64-Linux.db.zstd
 736K   │ │ │ ├── loongarch64-Linux.json.zstd
 716K   │ │ │ ├── loongarch64-Linux.json.xz
 4.0K   │ │ │ ├── x86_64-Linux.json.zstd.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.xz.bsum
 4.0K   │ │ │ ├── x86_64-Linux.json.bsum
 4.0K   │ │ │ ├── x86_64-Linux.db.zstd.bsum
...
1016K   │ │ ├── aarch64-Linux.sdb.zstd
 ...
 332K   │ │ ├── DIFF_bincache_riscv64-Linux.json
