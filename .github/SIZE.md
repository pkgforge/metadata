...
937M   │ ├─┬ pkgforge-go
937M   │ │ ├─┬ data
 82M   │ │ │ ├── x86_64-Linux.json
 81M   │ │ │ ├── riscv64-Linux.json
 81M   │ │ │ ├── aarch64-Linux.json
 81M   │ │ │ ├── loongarch64-Linux.json
 66M   │ │ │ ├── x86_64-Linux.db
 65M   │ │ │ ├── riscv64-Linux.db
 65M   │ │ │ ├── loongarch64-Linux.db
 65M   │ │ │ ├── aarch64-Linux.db
 58M   │ │ │ ├── x86_64-Linux.sdb
 58M   │ │ │ ├── riscv64-Linux.sdb
 57M   │ │ │ ├── aarch64-Linux.sdb
 56M   │ │ │ ├── loongarch64-Linux.sdb
5.9M   │ │ │ ├── x86_64-Linux.sdb.zstd
5.8M   │ │ │ ├── riscv64-Linux.sdb.zstd
5.8M   │ │ │ ├── aarch64-Linux.sdb.zstd
5.7M   │ │ │ ├── loongarch64-Linux.sdb.zstd
5.6M   │ │ │ ├── x86_64-Linux.db.zstd
5.5M   │ │ │ ├── riscv64-Linux.db.zstd
5.5M   │ │ │ ├── x86_64-Linux.sdb.xz
5.5M   │ │ │ ├── aarch64-Linux.db.zstd
5.4M   │ │ │ ├── riscv64-Linux.sdb.xz
5.4M   │ │ │ ├── aarch64-Linux.sdb.xz
5.4M   │ │ │ ├── loongarch64-Linux.db.zstd
5.3M   │ │ │ ├── x86_64-Linux.db.xz
5.3M   │ │ │ ├── loongarch64-Linux.sdb.xz
5.3M   │ │ │ ├── riscv64-Linux.db.xz
5.2M   │ │ │ ├── aarch64-Linux.db.xz
5.1M   │ │ │ ├── loongarch64-Linux.db.xz
5.0M   │ │ │ ├── x86_64-Linux.json.zstd
5.0M   │ │ │ ├── riscv64-Linux.json.zstd
4.9M   │ │ │ ├── aarch64-Linux.json.zstd
4.8M   │ │ │ ├── loongarch64-Linux.json.zstd
...
988K   │ │ │ ├── loongarch64-Linux.json.zstd
960K   │ │ │ ├── loongarch64-Linux.json.xz
4.0K   │ │ │ ├── x86_64-Linux.sdb.zstd.bsum
4.0K   │ │ │ ├── x86_64-Linux.sdb.xz.bsum
...
816K   │ │ ├── COMP_VER_CACHE_OLD.json
780K   │ │ ├── pub_issues_binaries.txt
580K   │ │ ├── OLD_bincache_riscv64-Linux.json
548K   │ │ ├── DIFF_bincache_aarch64-Linux.json
524K   │ │ ├── DIFF_bincache_x86_64-Linux.json
384K   │ │ ├── INDEX.json.cba
340K   │ │ ├── COMP_VER_CACHE_OLD.md
312K   │ │ ├── DIFF_bincache_riscv64-Linux.json
304K   │ │ ├── pub_issues_packages.txt
284K   │ │ ├── OLD_pkgcache_x86_64-Linux.json
244K   │ │ ├── INDEX.db.cba
240K   │ │ ├── GH_REPO.md
236K   │ │ ├── INDEX.json.xz
