...
284K   │ │ ├── aarch64-Linux.json.cba
280K   │ │ ├── x86_64-Linux.json.zstd
252K   │ │ ├── aarch64-Linux.db.zstd
244K   │ │ ├── aarch64-Linux.db.xz
236K   │ │ ├── aarch64-Linux.json.xz
224K   │ │ ├── aarch64-Linux.json.zstd
...
100K   │ │ ├── INDEX.db.zstd
 96K   │ │ ├── INDEX.db.xz
 64K   │ │ ├── DIFF_bincache.json
 56K   │ │ ├── DIFF_bincache_x86_64-Linux.json
 40K   │ │ ├── DIFF_bincache_aarch64-Linux.json
 28K   │ │ ├── URLS.txt
 28K   │ │ ├── GH_REPO_ARCHIVED.md
 16K   │ │ ├── DIFF_pkgcache_x86_64-Linux.json
