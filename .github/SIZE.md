...
914M   │ ├─┬ pkgforge-go
914M   │ │ ├─┬ data
 80M   │ │ │ ├── x86_64-Linux.json
 79M   │ │ │ ├── riscv64-Linux.json
 79M   │ │ │ ├── aarch64-Linux.json
 79M   │ │ │ ├── loongarch64-Linux.json
 64M   │ │ │ ├── x86_64-Linux.db
 64M   │ │ │ ├── riscv64-Linux.db
 64M   │ │ │ ├── loongarch64-Linux.db
 63M   │ │ │ ├── aarch64-Linux.db
 57M   │ │ │ ├── x86_64-Linux.sdb
 56M   │ │ │ ├── riscv64-Linux.sdb
 56M   │ │ │ ├── aarch64-Linux.sdb
 55M   │ │ │ ├── loongarch64-Linux.sdb
5.8M   │ │ │ ├── x86_64-Linux.sdb.zstd
5.7M   │ │ │ ├── riscv64-Linux.sdb.zstd
5.7M   │ │ │ ├── aarch64-Linux.sdb.zstd
5.6M   │ │ │ ├── loongarch64-Linux.sdb.zstd
5.5M   │ │ │ ├── x86_64-Linux.db.zstd
5.4M   │ │ │ ├── x86_64-Linux.sdb.xz
5.4M   │ │ │ ├── riscv64-Linux.db.zstd
5.4M   │ │ │ ├── aarch64-Linux.db.zstd
5.3M   │ │ │ ├── riscv64-Linux.sdb.xz
5.3M   │ │ │ ├── aarch64-Linux.sdb.xz
5.2M   │ │ │ ├── loongarch64-Linux.db.zstd
5.2M   │ │ │ ├── x86_64-Linux.db.xz
5.2M   │ │ │ ├── loongarch64-Linux.sdb.xz
5.2M   │ │ │ ├── riscv64-Linux.db.xz
5.1M   │ │ │ ├── aarch64-Linux.db.xz
5.0M   │ │ │ ├── loongarch64-Linux.db.xz
4.9M   │ │ │ ├── x86_64-Linux.json.zstd
4.9M   │ │ │ ├── riscv64-Linux.json.zstd
4.8M   │ │ │ ├── aarch64-Linux.json.zstd
4.7M   │ │ │ ├── loongarch64-Linux.json.zstd
...
9.4M   │ │ │ ├── loongarch64-Linux.db
8.9M   │ │ │ ├── x86_64-Linux.sdb
8.9M   │ │ │ ├── aarch64-Linux.sdb
8.6M   │ │ │ ├── riscv64-Linux.sdb
7.3M   │ │ │ ├── loongarch64-Linux.sdb
...
984K   │ │ │ ├── loongarch64-Linux.json.zstd
956K   │ │ │ ├── loongarch64-Linux.json.xz
4.0K   │ │ │ ├── x86_64-Linux.sdb.zstd.bsum
4.0K   │ │ │ ├── x86_64-Linux.sdb.xz.bsum
...
4.2M   │ │ │ ├── x86_64-Linux.db
4.1M   │ │ │ ├── x86_64-Linux.sdb
...
163M   │ ├─┬ data
 ...
 28M   │ │ ├── aarch64-Linux.json
 19M   │ │ ├── aarch64-Linux.db
 19M   │ │ ├── x86_64-Linux.db
 15M   │ │ ├── x86_64-Linux.sdb
 15M   │ │ ├── aarch64-Linux.sdb
4.5M   │ │ ├── x86_64-Linux.json.cba
4.3M   │ │ ├── aarch64-Linux.json.cba
...
956K   │ │ ├── x86_64-Linux.sdb.xz
952K   │ │ ├── aarch64-Linux.sdb.xz
940K   │ │ ├── x86_64-Linux.db.zstd
932K   │ │ ├── aarch64-Linux.db.zstd
908K   │ │ ├── x86_64-Linux.json.zstd
900K   │ │ ├── aarch64-Linux.json.zstd
876K   │ │ ├── x86_64-Linux.db.xz
872K   │ │ ├── x86_64-Linux.json.xz
864K   │ │ ├── aarch64-Linux.json.xz
...
124K   │ └─┬ scripts
 ...
 19M   │ ├─┬ data
2.6M   │ │ ├── INDEX.json
2.4M   │ │ ├── COMP_VER_CACHE.json
2.0M   │ │ ├── BACKAGE.json
1.5M   │ │ ├── OLD_bincache_x86_64-Linux.json
1.4M   │ │ ├── OLD_bincache_aarch64-Linux.json
1.4M   │ │ ├── INDEX.db
972K   │ │ ├── COMP_VER_bincache_x86_64-Linux.json
972K   │ │ ├── COMP_VER_bincache_aarch64-Linux.json
920K   │ │ ├── COMP_VER_CACHE.md
784K   │ │ ├── pub_issues_binaries.txt
580K   │ │ ├── OLD_bincache_riscv64-Linux.json
508K   │ │ ├── DIFF_bincache_x86_64-Linux.json
372K   │ │ ├── INDEX.json.cba
372K   │ │ ├── DIFF_bincache_aarch64-Linux.json
308K   │ │ ├── DIFF_bincache_riscv64-Linux.json
304K   │ │ ├── pub_issues_packages.txt
304K   │ │ ├── COMP_VER_CACHE_OLD.json
280K   │ │ ├── OLD_pkgcache_x86_64-Linux.json
244K   │ │ ├── INDEX.db.cba
240K   │ │ ├── GH_REPO.md
236K   │ │ ├── INDEX.json.xz
228K   │ │ ├── INDEX.json.zstd
200K   │ │ ├── OLD_pkgcache_aarch64-Linux.json
192K   │ │ ├── INDEX.db.zstd
180K   │ │ ├── INDEX.db.xz
124K   │ │ ├── COMP_VER_CACHE_OLD.md
100K   │ │ ├── DIFF_pkgcache_x86_64-Linux.json
