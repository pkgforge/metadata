...
gh api "/orgs/pkgforge/packages?package_type=container" --paginate | jq -r '.[] | select(.visibility=="public") | .name' | grep -i 'pkgcache' | sort -u -o "${TMPDIR}/ghcr_pkgs.tmp"
...
if command -v rclone &> /dev/null &&\
 [ -s "${HOME}/.rclone.conf" ] &&\
 [ -s "${SYSTMP}/pkgcache_x86_64-Linux.json" ] &&\
 [ -d "${GITHUB_WORKSPACE}" ] &&\
 ...
 #To Sqlite
  if command -v "qsv" >/dev/null 2>&1; then
    ...
    if [[ -s "${TMPDIR}/x86_64-Linux.db" && $(stat -c%s "${TMPDIR}/x86_64-Linux.db") -gt 1024 ]]; then
     cp -fv "${TMPDIR}/x86_64-Linux.db" "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db" ; generate_checksum "x86_64-Linux.db"
     bita compress --input "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db" --compression "zstd" --compression-level "21" --force-create "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.cba"
     7z a -t7z -mx="9" -mmt="$(($(nproc)+1))" -bsp1 -bt "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.xz" "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db" 2>/dev/null ; generate_checksum "x86_64-Linux.db.xz"
     zstd --ultra -22 --force "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db" -o "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.zstd" ; generate_checksum "x86_64-Linux.db.zstd"
     #Upload
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db" "r2:/meta/pkgcache/x86_64-Linux.db" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.bsum" "r2:/meta/pkgcache/x86_64-Linux.db.bsum" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.cba" "r2:/meta/pkgcache/x86_64-Linux.db.cba" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.xz" "r2:/meta/pkgcache/x86_64-Linux.db.xz" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.xz.bsum" "r2:/meta/pkgcache/x86_64-Linux.db.xz.bsum" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.zstd" "r2:/meta/pkgcache/x86_64-Linux.db.zstd" --checksum --check-first --user-agent="${USER_AGENT}" &
      rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.db.zstd.bsum" "r2:/meta/pkgcache/x86_64-Linux.db.zstd.bsum" --checksum --check-first --user-agent="${USER_AGENT}" &
    fi
  fi
 #To xz
 ...
 #Upload (Json)
  ...
  rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.json.cba" "r2:/meta/pkgcache/x86_64-Linux.json.cba" --checksum --check-first --user-agent="${USER_AGENT}" &
  rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.json.xz" "r2:/meta/pkgcache/x86_64-Linux.json.xz" --checksum --check-first --user-agent="${USER_AGENT}" &
  rclone copyto "${GITHUB_WORKSPACE}/main/pkgcache/data/x86_64-Linux.json.xz.bsum" "r2:/meta/pkgcache/x86_64-Linux.json.xz.bsum" --checksum --check-first --user-agent="${USER_AGENT}" &
