...
.download-upx-button .icon {
    font-size: 18px;
    margin-right: 6px;
    color: #fff;
}
.download-button:hover,
.download-upx-button:hover {
...
td.download-upx-button {
    padding: 0;
    vertical-align: middle;
}

td.actions a,
td.download-upx-button a {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 100%;
